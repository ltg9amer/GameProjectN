...
namespace MoreMountains.CorgiEngine
{
    ...
    public class Character : CorgiMonoBehaviour
    {
        ...
        public virtual void ChangeAnimator(Animator newAnimator)
        {
            ...
            _animator.runtimeAnimatorController = (_animator.runtimeAnimatorController == CorgiFrontController ? CorgiBackController : CorgiFrontController);
